...
export const buildNounPluralFormPrompt = (word: string): string => {
  return `You are a linguistic assistant. Your task is to provide the plural form of a German noun.
