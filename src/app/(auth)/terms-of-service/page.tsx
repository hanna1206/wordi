        ...
        <VStack align="stretch" gap={{ base: 6, md: 8 }}>
          ...
          <VStack align="stretch" gap={6}>
            <Section title="Agreement to Terms">
              <Text>
                By accessing and using Wordi, you accept and agree to be bound
            ...
            <Section title="Intellectual Property">
              <Text>
                ...
                owned by Wordi and are protected by copyright, trademark, and
            ...
            <Section title="User-Generated Content">
              <Text>
                ...
                and display that content in connection with our service. You
            ...
            <Section title="Limitation of Liability">
              <Text>
                To the fullest extent permitted by law, Wordi shall not be
